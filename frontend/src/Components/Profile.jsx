                      ...
                      <div>
                        <div className="flex w-[200px] lg:w-auto flex-wrap justify-between p-2">
                          ...
                          {email === localStorage.getItem("email") && (
                            <div className="flex gap-x-2 lg:gap-x-4 my-4 lg:my-0">
                              ...
                              >
                                <Edit />
                                <p className="font-semibold text-black text-sm lg:text-lg">Edit</p>
                              </button>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="flex w-[200px] lg:w-auto flex-wrap gap-x-2 lg:gap-x-4 text-gray-800">
                          <div className="flex gap-x-2 text-sm lg:text-md p-2">
                            <LocationEdit size={15} className="block lg:hidden"/>
                          ...
                          <div className="flex gap-x-2 text-sm lg:text-md p-2">
                            ...
                            <p>
                              Joined{" "}
                              {moment(profile[0].createdAt).fromNow()}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="mb-5 flex items-center gap-x-4 lg:gap-x-8">
                          <div className="flex gap-x-2 items-end">
                            ...
                            <p className="text-gray-600 text-xs lg:text-md">Posts</p>
                          </div>
                          ...
                          <div className="flex gap-x-2 items-end">
                            ...
                            <p className="text-gray-600 text-xs lg:text-md">Followers</p>
                          </div>
                          ...
                          <div className="flex gap-x-2 items-end">
                            ...
                            <p className="text-gray-600 text-xs lg:text-md">Following</p>
                          </div>
                        </div>
                      </div>
                    </div>
